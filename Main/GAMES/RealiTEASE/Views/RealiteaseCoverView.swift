...
struct RealiteaseCoverView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .background(
                NavigationLink(
                    destination: RealiteaseGameView(manager: manager, navigateToRealitease: $navigateToRealitease, navigateToGame: $navigateToGame, gameDate: gameDate).navigationBarHidden(true),
