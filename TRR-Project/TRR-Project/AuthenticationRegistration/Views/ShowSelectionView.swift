        ...
        NavigationStack {
            ZStack {
                ...
                VStack {
                    ...
                    NavigationLink(destination: RealHousewivesSelectionView(selectedShows: $viewModel.selectedShows, selectedRealHousewivesShows: $viewModel.selectedRealHousewivesShows), isActive: $navigateToRealHousewivesSelection) {
                        EmptyView()
                    }
