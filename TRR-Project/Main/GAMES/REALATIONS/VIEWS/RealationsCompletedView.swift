...
struct RealationsCompletedView: View {
    ...
    private func fetchUserStats() {
        ...
        userDocRef.getDocument { document, error in
            if let document = document, document.exists {
                ...
                let puzzlesAttempted = data?["realations_PuzzlesAttempted"] as? Int ?? 0
                let puzzlesWon = data?["realations_PuzzlesWon"] as? Int ?? 0
                let currentStreak = data?["realations_CurrentStreak"] as? Int ?? 0
                let longestStreak = data?["realations_longestStreak"] as? Int ?? 0
...
struct RealationsCompletedView_Previews: PreviewProvider {
    static var previews: some View {
        RealationsCompletedView(manager: RealationsManager(), correctAnswer: "Sample Answer")
    }
}
